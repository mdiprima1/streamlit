...
def plot_comparison_percentiles(percentiles_A, percentiles_B, asset_A_2_5_percent, asset_B_2_5_percent):
    ...
    ax.text(0, asset_A_2_5_percent, f"{asset_A_2_5_percent:.2f}", color="blue", fontsize=14, fontweight="bold", verticalalignment='bottom')
    ax.text(0, asset_B_2_5_percent, f"{asset_B_2_5_percent:.2f}", color="red", fontsize=14, fontweight="bold", verticalalignment='bottom')
...
# Simulate Asset A and Asset B
simulation_data_A = monte_carlo_simulation(**asset_A_params)
simulation_data_B = monte_carlo_simulation(**asset_B_params)
